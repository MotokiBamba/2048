...
int main()
{
    ...
    init_pair(15, COLOR_RED, COLOR_RED);            // 数字オブジェクト256のカラー
    init_pair(16, COLOR_BLACK, COLOR_RED);

    init_pair(17, COLOR_GREEN, COLOR_GREEN);        // 数字オブジェクト512のカラー
    init_pair(18, COLOR_BLACK, COLOR_GREEN);

    init_pair(19, COLOR_BLUE, COLOR_BLUE);          // 数字オブジェクト1024のカラー
    ...
    for (int i = 0; i < 2; i++) {   // 初期数字オブジェクトを生成
